...
public final class ApiBlocks implements IBlocks {
  ...
  private final ITileDefinition craftingAcceleratorT4;
  private final ITileDefinition craftingAcceleratorT5;
  ...
  public ApiBlocks(FeatureFactory registry, PartModels partModels) {
    ...
    this.craftingAcceleratorT3 = crafting.block("crafting_accelerator_t3", () -> new BlockCraftingUnit(CraftingUnitType.ACCELERATOR_T3))
        ...
        .useCustomItemModel()
        .build();
    this.craftingAcceleratorT4 = crafting.block("crafting_accelerator_t4", () -> new BlockCraftingUnit(CraftingUnitType.ACCELERATOR_T4))
        .rendering(new CraftingCubeRendering("crafting_accelerator_t4", CraftingUnitType.ACCELERATOR_T4))
        .tileEntity(new TileEntityDefinition(TileCraftingTile.class, "crafting_unit"))
        .useCustomItemModel()
        .build();
    this.craftingAcceleratorT5 = crafting.block("crafting_accelerator_t5", () -> new BlockCraftingUnit(CraftingUnitType.ACCELERATOR_T5))
        .rendering(new CraftingCubeRendering("crafting_accelerator_t5", CraftingUnitType.ACCELERATOR_T5))
        .tileEntity(new TileEntityDefinition(TileCraftingTile.class, "crafting_unit"))
        .useCustomItemModel()
        .build();
  ...
  @Override
  public ITileDefinition craftingAcceleratorT4() {
    return this.craftingAcceleratorT4;
  }

  @Override
  public ITileDefinition craftingAcceleratorT5() {
    return this.craftingAcceleratorT5;
  }
