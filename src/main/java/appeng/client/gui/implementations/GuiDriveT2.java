...
import appeng.container.implementations.ContainerDriveT2;
...
public class GuiDriveT2 extends AEBaseGui {

    private GuiTabButton priority;

    public GuiDriveT2(final InventoryPlayer inventoryPlayer, final TileDriveT2 te) {
        super(new ContainerDriveT2(inventoryPlayer, te));
        this.ySize = 199;
    }
    ...
    public void drawBG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        this.bindTexture("guis/drive_t2.png");
